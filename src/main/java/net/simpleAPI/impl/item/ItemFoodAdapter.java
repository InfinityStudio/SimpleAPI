 ...
 * @author ci010
 */
public class ItemFoodAdapter extends ItemFood implements ItemAdapter
{
	...
	public ItemFoodAdapter(int amount, float saturation, boolean isWolfFood)
	{
	...
	@Override
	public Function<ICapabilityProvider, Map<ResourceLocation, ICapabilityProvider>> getCapabilityFactory()
	{
		return null;
	}
	...
	public ItemFoodAdapter setUpdate(ItemUpdate update)
	{
		this.update = update;
		return this;
	}

	public ItemFoodAdapter setUsing(ItemUsing using)
	{
		this.using = using;
		return this;
	}

	public ItemFoodAdapter setInteract(ItemEntityInteract interact)
	{
		this.interact = interact;
		return this;
	}

	public ItemFoodAdapter setBlockInteract(ItemBlockInteract blockInteract)
	{
		this.blockInteract = blockInteract;
		return this;
	}

	public ItemFoodAdapter setHandler(ItemEntityHandler handler)
	{
		this.handler = handler;
		return this;
	}

	public ItemFoodAdapter setCreate(ItemCreate create)
	{
		this.create = create;
		return this;
	}

	public ItemFoodAdapter setDestroy(ItemBlockDestroy destroy)
	{
